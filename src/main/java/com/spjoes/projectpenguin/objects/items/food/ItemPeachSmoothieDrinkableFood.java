...
public class ItemPeachSmoothieDrinkableFood extends ItemFood implements IHasModel
{

    public ItemPeachSmoothieDrinkableFood(String name, int amount, boolean isWolfFood) {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player){
        if (!worldIn.isRemote){
            ...
            //Effect2
            player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 1000, 0));
            //Effect3
